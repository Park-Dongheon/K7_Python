...
ship_img = pygame.image.load('0517_alien_invasion_refectoring/images/ship.bmp')
alien_img = pygame.image.load('0517_alien_invasion_refectoring/images/alien.bmp')
